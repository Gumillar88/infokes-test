								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse">
											...
											<div class="menu-item">
												<a class="menu-link active" href="../../demo1/dist/dashboards/social.html">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse_2">
														...
														<div class="menu-item">
															<a class="menu-link active py-3" href="../../demo1/dist/dashboards/social.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Social</span>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Social Dashboard</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								<!--begin::Actions-->
											...
											<div class="card-body pt-1">
												...
												<div class="d-flex flex-stack flex-wrap gap-4">
													...
													<div class="d-flex align-items-center gap-4">
														...
														<!--begin::Menu 1-->
														<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6244764c640f9">
															<!--begin::Header-->
															<div class="px-7 py-5">
															...
															<div class="px-7 py-5">
																...
																<div class="mb-10">
																	...
																	<!--begin::Input-->
																	<div>
																		<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6244764c640f9" data-allow-clear="true">
																			<option></option>
									...
									<div class="col-xl-4">
										...
										<div class="card card-flush h-lg-100">
											...
											<div class="card-body d-flex justify-content-between flex-column p-0">
												...
												<!--end::Items-->
												<!--begin::Chart-->
												<div class="charts-widget-2 card-rounded-bottom" data-kt-chart-color="primary" style="height: 90px"></div>
												<!--end::Chart-->
											</div>
											<!--end::Body-->
										</div>
